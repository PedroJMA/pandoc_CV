...
Experiencia en el Grupo Banco Mundial: 5 años y 4 meses
---------------------------
Jul'24 - Ene'26 : **Consultor Internacional** para el proyecto "Movilización eficaz de los ingresos internos para el crecimiento inclusivo" para estimar un modelo de microsimulación de impuestos (IVA, ISR) y otras herramientas de política fiscal para la Dirección de Política y Análisis Fiscal del Ministerio de Finanzas Públicas de Guatemala. 

Jun'23-Jun'24 : **Investigador Asociado** para estimar las exportaciones e inversiones potenciales derivadas del *nearshoring* en América Latina. Consultoría para LAC Creating Markets Advisory IFC, con sede en la Ciudad de México. Bajo el liderazgo del equipo, proporcioné un **marco analítico** para estimar las oportunidades de *nearshoring* en México, países de Centroamérica, Colombia y Perú.
